AFRAME.registerComponent('tap-actions',{init:function(){
  const el=this.el; let rotated=false;
  el.sceneEl.addEventListener('click',()=> {
    rotated=!rotated;
    el.setAttribute('animation',{property:'rotation',to:rotated?'0 360 0':'0 0 0',loop:false,dur:1200,easing:'easeInOutQuad'});
  });
}});
